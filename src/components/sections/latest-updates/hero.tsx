...
export function LatestUpdatesHero({ title, subtitle }: HeroProps) {
  return (
    <div className="bg-[#0F172A] text-white py-16 border-b border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-4">
        ...
        <nav className="text-xs text-white/50 space-x-2 font-sans tracking-wide">
          <span>Home</span>
          <span>/</span>
          <span className="text-accent-gold">Latest Updates</span>
        </nav>
        ...
        {/* Subtitle */}
        <p className="text-sm sm:text-base text-white/70 font-sans max-w-xl mx-auto leading-relaxed">
          {subtitle}
        </p>
